...
public class FaiLed_Booking {
	...
	public void failed_flightdetails(String UserName,String Password)throws  Exception{
		...
		ObjectMethods.clickElement(FlightFinder_Page.SELECT_BUY);
